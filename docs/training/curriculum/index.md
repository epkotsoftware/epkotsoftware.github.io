...
```txt
勤務中は常にSlackをチェックし、15分以内にリアクション・返信すること。怠った場合は社内ルールに基づき、対処させていただきます。
```

## カリキュラム

【非常に重要】
- 2026/9より順次カリキュラムを更新しています。誤字脱字、不具合に見つけた場合、気づいた瞬間に講師に報告することを義務とします。怠ったことで研修が遅延したりトラブルが発生した場合でも配慮しません。
- 困りごとはすぐに質問チャンネルでききましょう。
