...
- その他
  ...
  - コンビニでバイトしたことありますか？（コンビニのシステムの現場）
...
PHPのバージョン情報については、以下になります。  
セキュリティサポートが切れたものを使い続けている現場もあります。  
以下、2022/08時点のバージョン情報です。  
最新の情報は公式を参照してください。  
...
Laravel7は既にサポートが終了しており  
実務では、LTS(Long Term Support)バージョンが採用されやすいため  
Laravel7の情報は除いています。  
以下、2022/08時点のバージョン情報です。  
最新の情報は公式を参照してください。  

| Laravel<br>バージョン | PHP<br>バージョン | リリース | バグフィックス<br>期日 | セキュリティ<br>修正期日 |
| --- | --- | :---: | :---: | :---: |
